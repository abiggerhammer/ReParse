define(["require", "exports", "module"], function(require, exports, module) {
  ...
  // Return a list of exactly N productions.
  reparse.prototype.count = function count(method, n) {
    var result = [],
        input = this.input,
        c = 0;
    ...
    while (c < n) {
      ...
      try {
        ...
        console.log("some error or another");
        if (err !== this.fail)
          throw err;
        break;
      }
    }
    return (result.length == c) ? result : this.fail(input);
  };
